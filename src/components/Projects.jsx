...
const Projects = () => {
  return (
    <section className=" container  grid  mt-10 md:grid-cols-2 lg:grid-cols-3 gap-10"id='Projects'>
      ...
      {projects.map((item) => (
        <div className="max-w-sm m-8  rounded overflow-hidden shadow-lg" key={item.id}>
          <div className="px-6 py-4">
            ...
            <button className=" bg-blue-500 mt-5 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" ><a>More Info</a></button>
