    ...
    return (
        <main className="container mx-auto px-5 grid md:grid-cols-2 items-center justify-center md:justify-between " >
            <section className="flex-column ml-3">
                <h2 className="font-serif text-left mx-10 md:text-left" ><span className="italic font-bold"> Davide Castelli</span></h2>
                ...
                <button class="bg-blue-500 m-7 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" ><a href="/#About">About Me</a></button>
            </section>
            <section>
